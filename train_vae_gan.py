...
from utils import Discriminator, gan_loss_fake, gan_loss_real
...
def main():
    ...
    lr_scheduler_gan = get_scheduler(
        args.lr_scheduler,
    ...
    vae, discriminator, optimizer, optimizer_gan, train_dataloader, lr_scheduler, lr_scheduler_gan = accelerator.prepare(
        vae, discriminator, optimizer, optimizer_gan, train_dataloader, lr_scheduler, lr_scheduler_gan
    )
    accelerator.register_for_checkpointing(lr_scheduler)
    accelerator.register_for_checkpointing(lr_scheduler_gan)
